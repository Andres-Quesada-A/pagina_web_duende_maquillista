...
function Order({ id, timestamp, address }) {
    ...
    return (
        <div className="w-full flex flex-row gap-2 items-start border-2 border-stone-400 p-2.5 rounded-md items-center hover:bg-stone-200 hover:border-indigo-400" onClick={handleClick}>
